...
export default function InstructorSegment({ segment, services, onChange, onDuplicate, onDelete, rate, errors = {} }) {
    ...
    <div className="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 p-4 md:p-5">
      ...
      <div className="grid grid-cols-12 gap-4 items-start">
        <div className="col-span-6 md:col-span-7 space-y-1">
          ...
          <Select value={segment.service_id} onValueChange={v => onChange(segment.id, { service_id: v })}>
            <SelectTrigger className="h-10 text-base leading-6">
        ...
        <div className="col-span-3 md:col-span-2 space-y-1">
          ...
          <Input type="number" min="1" value={segment.sessions_count} onChange={e => onChange(segment.id, { sessions_count: e.target.value })} className="bg-white h-10 text-base leading-6" />
        ...
        <div className="col-span-3 md:col-span-3 space-y-1">
          ...
          <Input type="number" min="1" value={segment.students_count} onChange={e => onChange(segment.id, { students_count: e.target.value })} className="bg-white h-10 text-base leading-6" />
