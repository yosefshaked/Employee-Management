...
- כרטיס "פעילות אחרונה" בלוח הבקרה משתמש כעת בעזר `getActivityDisplayDetails` כדי למפות את `entry_type` של רישומי עבודה לתוויות עבריות מדויקות עבור חופשות, התאמות ושירותי מדריכים, ומציג צבע תגית דינמי על בסיס צבע השירות, ירוק ייעודי לחופשות, סגול להתאמות וצבע טורקיז כירידת מחדל.
