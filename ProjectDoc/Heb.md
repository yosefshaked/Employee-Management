...
- **שילוב Frontend:** הקבצים `InviteUserForm.jsx` ו-`OrgMembersCard.jsx` המעודכן משתמשים ב-`src/api/invitations.js` לשליחת הזמנות ולהצגת רשימת ההמתנה עם תגים ידידותיים ומצבי טעינה/שגיאה ברורים.
