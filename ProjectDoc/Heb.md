...
ניתן להפעיל מצב **"בחר תאריכים להזנה מרובה"** בטבלת ההזנה כדי לבחור כמה תאריכים ולסנן עובדים דרך רשימת תיבות סימון. סרגל עליון מציג את התאריכים שנבחרו וכפתור **"העתק מהתאריך הקודם"** להעתקת הערכים. שאלת ההעתקה מופיעה רק בעת מעבר בין תאריכים במצב מרובה.
